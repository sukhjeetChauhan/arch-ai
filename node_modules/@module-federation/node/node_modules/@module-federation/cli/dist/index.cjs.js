...
function runCli(options) {
    const normalizedOptions = Object.assign({ loggerPrefix: PREFIX, welcomeMsg: `${`Module Federation v${"0.22.0"}`}\n`, name: 'mf', readConfig, version: "0.22.0", applyCommands: () => { } }, options);
